...
/*
Output:
➜  ARP_test git:(master) ✗ sudo ./a.out lo 172.30.104.255
get_if_info for lo
interface index is 1
get_if_info OK
Clean up temporary socket
bind_arp: ifindex=1
Binding to ifindex 1
...
➜  ARP_test git:(master) ✗ sudo ./a.out eno1 172.30.104.255
get_if_info for eno1
...
read_arp
received ARP len=60
Sender IP: 172.30.105.242
Sender MAC: 54:EE:75:77:E4:F7
Got reply, break out
