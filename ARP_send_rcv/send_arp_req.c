...
➜  ARP_send_rcv git:(master) ✗ sudo ./recv_arp_reply

Ethernet frame header:
Destination MAC (this node): ec:8e:b5:54:da:db
Source MAC: 54:ee:75:77:e4:f7
...
Sender hardware (MAC) address: 54:ee:75:77:e4:f7
Sender protocol (IPv4) address: 172.30.105.242
Target (this node) hardware (MAC) address: ec:8e:b5:54:da:db
Target (this node) protocol (IPv4) address: 69.69.69.69
